  ...
  return (
    <div className="overlay">
      <div className="dialog">
        <div className="dialog-title"><Icon name="calendar" size={20}/>{isNew?"New Event":"Edit Event"}</div>
...
function DayPanel({ athleteId, dateStr, onClose, toast }) {
  ...
  async function handleSave() {
    ...
    setSaving(true);
    try {
      await apiPut(`/athletes/${athleteId}/calendar/day/${dateStr}`, { steps:+form.steps, aerobic_type:form.aerobic_type, aerobic_duration:+form.aerobic_duration, workout_notes:form.workout_notes });
